        ...
        try {
           ...
           /* HSSFCell cell8 = headerRow.createCell(8);
            ...
            while(it1.hasNext()){
                ...
                row.createCell(1).setCellValue(MapUtils.getStringValue(map,"bdCode"));
                row.createCell(2).setCellValue(MapUtils.getStringValue(map,"clientName"));
                row.createCell(3).setCellValue(MapUtils.getStringValue(map,"wareCode"));
                row.createCell(4).setCellValue(MapUtils.getStringValue(map,"wareName"));
                row.createCell(5).setCellValue(MapUtils.getStringValue(map,"unitName"));
                row.createCell(6).setCellValue(MapUtils.getStringValue(map,"wareModel"));
                row.createCell(7).setCellValue(MapUtils.getStringValue(map,"orderCode"));
                ...
                row.createCell(9).setCellValue(MapUtils.getStringValue(map,"gzManName"));
                List list = (List) map.get("gx");
                int tint2 = 9;
                int maxj = list.size();
                double Zmoney = 0d;
